<template>
  <div class="login">
    <div class="box has-padding-medium">
      ...
      <p
        v-if="isConfirm"
      >Please enter the verification code which was sent to your registered email address</p>
      ...
      <form class="has-margin-bottom-medium" @submit.prevent="submit()">
        <div v-if="!isConfirm" class="field">
          <div class="control has-icons-left has-icons-right">
            ...
            <span v-if="hasErrors" class="icon is-small is-right has-text-danger">
        ...
        <div v-if="isLogin || isReset" class="field">
          <div class="control has-icons-left has-icons-right">
            ...
            <slot name="password-strength" :password="password" :has-password="hasPassword"/>
          </div>
        </div>
        <div v-if="isReset" class="field">
          <div class="control has-icons-left has-icons-right">
            ...
            <span v-if="match && !hasErrors" class="icon is-small is-right has-text-success">
              <fa icon="check"/>
            </span>
          </div>
        </div>
